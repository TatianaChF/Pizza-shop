...
import {clearProducts} from "../../redux/cart/cartSlice.ts";
...
const Cart = () => {
    ...
    const onClickClear = () => {
        if (window.confirm(t('cart.clearConfirmation'))) {
                    ...
                    <div className={styles.cart__bottom}>
                        ...
                        <div className={styles.cart__bottom__buttons}>
                            <div className={styles.button}>
                                <div className={styles.button__outline}>
                            ...
                            <div className={styles.button__pay}>
                                <span>{`${t('cart.buyButton')}`}</span>
                            </div>
                        </div>
                    </div>
                </div>
